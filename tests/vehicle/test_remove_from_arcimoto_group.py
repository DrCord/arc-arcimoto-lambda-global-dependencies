...
class TestRemoveFromArcimotoGroup(unittest.TestCase, VehicleTestHelper):
    ...
    # test successes
    def test_remove_from_arcimoto_group_success(self):
        try:
            self.VehicleObject.remove_from_arcimoto_group(mute=True)
