...
class TestVehicleModelReleaseGet(unittest.TestCase, VehicleTestHelper):
    ...
    # test successes
    def test_vehicle_model_release_get_success(self):
        try:
            self.VehicleObject.vehicle_model_release_get()
